...
class Student:
    def __init__(self,root):
        ...
        # search button
        search_btn=Button(Search_frame,text="Search",font=("times new roman",12,"bold"),bg='blue',fg='white',width=9)
        search_btn.grid(row=0,column=3)
        #show all button
        showAll_btn=Button(Search_frame,text="Show All",font=("times new roman",12,"bold"),bg='blue',fg='white',width=9)
